...
const Dashboard = () => {
    ...
    const generatePicklistId = () => {
        ...
        // Add timestamp component (last 2 digits of current timestamp)
        const timestampComponent = Date.now().toString().slice(-2);

        // Combine them to create a more unique ID
        const uniqueId = (parseInt(randomId.slice(0, 3)) + parseInt(timestampComponent)).toString() +
            randomId.slice(3) +
            timestampComponent;

        // Take first 5 digits to ensure 5-digit output
                                ...
                                {filteredRecords.length === 0 ? (
                                    ...
                                    filteredRecords.map((record, index) => (
                                        ...
                                        >
                                            ...
                                            <td
                                                className={`${record.location === "Shipped" ? " text-white" : ""
