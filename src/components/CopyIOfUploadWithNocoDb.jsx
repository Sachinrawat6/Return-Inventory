...
const Uploads = () => {
  ...
  // uniquep picklist id generator
  const generatePicklistId = () => {
    return Math.floor(10000 + Math.random() * 90000); // generates 10000–99999
  };
  ...
  const syncPicklistToNocoDb = async () => {
    ...
    try {
      ...
      console.log("✅ Synced to NocoDB:", response.data);
      alert(`Picklist ID ${picklistId} synced successfully`);
    } catch (error) {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white shadow rounded-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r bg-gray-100 px-6 py-4">
            ...
            <button
              className="bg-white py-2 px-4 rounded shadow cursor-pointer"
