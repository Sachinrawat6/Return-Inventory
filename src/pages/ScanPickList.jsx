  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Picklist Scanner</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {picklistId
                ? "No records found for this picklist ID"
                : "Enter or scan a picklist ID to view records"}
            </p>
          </div>
        )}
      </div>
